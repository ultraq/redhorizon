 ...
 */
class Format80 implements Encoder, Decoder {
...
//	private static final int  CMD_COPY_L_THRESHOLD = 4
	...
	private static int[] isCandidateForOffsetCopyCommand(ByteBuffer source) {
		...
		return [candidatelength > CMD_OFFSET_THRESHOLD ? candidatelength : 0, candidateposition]
	}
	...
	private static int[] isCandidateForCopyCommand(ByteBuffer source) {
		...
		return [candidatelength > CMD_COPY_S_THRESHOLD ? candidatelength : 0, candidateposition]
	}
