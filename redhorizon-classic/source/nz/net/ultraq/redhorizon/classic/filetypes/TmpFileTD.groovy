...
/**
 * Representation of Tibium Dawn's map tiles.  These are the various bits and
 ...
 */
@FileExtensions(['des', 'tem', 'win'])
class TmpFileTD implements ImagesFile {
	...
	/**
	 * Constructor, create a new TD template file from data in the input stream.
	 */
	TmpFileTD(InputStream inputStream) {
