...
abstract class Application implements EventTarget<Application> {
	...
	/**
	 * Configure the asset manager to use in the application.
	 *
	 * @param assetManager
	 *   The provided asset manager will already have a classpath asset resolver
	 *   with a default prefix of the application's package.
	 */
