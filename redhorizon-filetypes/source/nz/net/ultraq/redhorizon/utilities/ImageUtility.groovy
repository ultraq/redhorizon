...
/**
 * Image utilities for working with image data from a file.
 * 
...
class ImageUtility {
	 ...
	 * @return A buffer of colourized data.
	 */
	static ByteBuffer applyPalette(ByteBuffer source, Palette palette) {

		def dest = ByteBuffer.allocateNative(source.limit() * palette.format.value)
		for (def i = 0; i < source.limit(); i++) {
			dest.put(palette[source.get()])
		}
		source.rewind()
		return dest.rewind()
	}
	 ...
	 * @param palette Palette data to use.
	 */
//	static void applyPalette(ByteBuffer[] source, ByteBuffer[] dest, Palette palette) {
//
...
//	}
	 ...
	 */
//	static void checkConsistentImages(ImageFile[] imagefiles) throws UnsupportedOperationException {
//
...
//	}
	 ...
	 */
//	static void checkNumImages(String targetclass, int numimgs, int maxnumimgs)
...
//	}
	 ...
	 */
//	static void checkNumImages(String sourcename, String targetclass, int numimgs, int maxnumimgs)
//		throws UnsupportedOperationException {
//
//		if (numimgs > maxnumimgs) {
...
//	}
	 ...
	 * 		   paletted file type.
	 */
//	static void checkPaletted(String sourcename, String targetclass, File sourcefile)
//		throws UnsupportedOperationException {
//
...
//	}
	 ...
	 */
//	static void checkSize(String sourcename, String targetclass, int width, int height,
...
//	}
	 ...
	 */
//	static ByteBuffer combineImages(int combinewidth, int combineheight,
...
//	}
	 ...
	 * @return Single combined image data.
	 */
//	static ByteBuffer combineImages(int numimgshor, int numimgsver,
...
//	}
	 ...
	 */
//	static int fitImagesAcross(int width, int numimages, int across) {
//
//		return width < across ?
...
//	}
	 ...
	 * 		   evenly as requested.
	 */
//	static ByteBuffer[] splitImage(int splitwidth, int splitheight, int numimages,
//		ImageFile imagefile) {
//
